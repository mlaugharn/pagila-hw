# pagila-hw
[![](https://github.com/mlaugharn/pagila-hw/workflows/tests/badge.svg)](https://github.com/mlaugharn/pagila-hw/actions?query=workflow%3Atests)
...
1. Fork this repo and clone it on the lambda server.
   ...
   ```
   $ git clone https://github.com/mlaugharn/pagila-hw
   $ cd pagila-hw
   $ git submodule init
